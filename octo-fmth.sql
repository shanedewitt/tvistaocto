...
-- Result: 65379,0
--
DROP FUNCTION IF EXISTS FUNCTION FMTH(INTEGER);
CREATE FUNCTION FMTH(INTEGER) RETURNS VARCHAR AS $$FMTH^XLFDT;

DROP FUNCTION IF EXISTS FUNCTION FMTH(INTEGER,INTEGER);
CREATE FUNCTION FMTH(INTEGER,INTEGER) RETURNS INTEGER AS $$FMTH^XLFDT;

DROP FUNCTION IF EXISTS FUNCTION FMTH(NUMERIC);
CREATE FUNCTION FMTH(NUMERIC) RETURNS VARCHAR AS $$FMTH^XLFDT;

DROP FUNCTION IF EXISTS FUNCTION FMTH(NUMERIC,INTEGER);
